...
<div class="content">
    ...
    <div id="promo">
            <div class="text2">
                <h3 align="center">Экономь и зарабатывай с промокодом Esalad!</h3>
                <p> Личный промокод дает скидку 5% на покупки<span class="error">*</span>  в интернет-магазине Esalad, а также позволяет зарабатывать с покупок друзей. </p>
                <p><b>Как это работает? </b><br>Поделитесь своим промокодом с близкими, и получайте кэшбэк с их покупок<span class="error">*</span>  на свой баланс в интернет-магазине Esalad.</p>
                <p class="font_size"><span class="error">*</span>Скидка действует на товары, участвующие в акции.</p>
            </div>
          <?php if(!Yii::$app->user->isGuest):?>
              <?php if(!empty($promo->code) && isset($promo->code)): ?>
