...
<div class="content">
    ...
    <div class="text">
        ...
        <p><b>2. Identifying Purposes</p></b>
        ...
        <p><b>5. Limiting Use, Disclosure and Retention </p></b>
        <p>Personal Information may only be used or disclosed for the purpose for which it was collected unless you have otherwise consented, or when it is required or permitted by law. Personal
        Information will only be retained for the period of time required to fulfill the purpose for which we collected it or as may be required by law.</p>
        <p><b>6. Accuracy </p></b>
        ...
        <p><b>7. Safeguarding Customer Information </p></b>
        ...
        <p><b>10. Handling Customer Complaints and Suggestions </p></b>
        ...
        Cookies are widely used and most web browsers are configured initially to accept cookies automatically.</p> <p>You may change your Internet browser settings to prevent your computer from
        accepting cookies or to notify you when you receive a cookie so that you may decline its acceptance.</p> <p>Please note, however, if you disable cookies, you may not experience optimal performance of our website.</p>
        <p><b>Other Websites </p></b>
