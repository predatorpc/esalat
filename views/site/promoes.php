...
<form>
    <fieldset class="sale_action">

    <h1 class="head1">Акция «Абонемент за покупки»</h1>

    <h3 class="head3">Купите в нашем магазине товары на 5.500 рублей и получите в подарок абонемент в Extreme Fitness на один месяц!</h3>
