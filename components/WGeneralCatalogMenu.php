       ...
       // print_arr($catalogMenu);
        ...
        <div class="items">
            ...
            <?php foreach($catalogMenu as $key => $item_group): ?>
                <div class="item selected hidden <?php if($item_group['id'] == 10000005):?> _s <?php endif; ?> <?php if($index++ < 4):?>_bg <?php endif; ?>">

                    <a class="menu-top hidden <?php if(strlen ($item_group['title']) > 26):?> max <?php endif;?>" href="/catalog/<?=$item_group['alias']?> " ><?=$item_group['title']?></a>
